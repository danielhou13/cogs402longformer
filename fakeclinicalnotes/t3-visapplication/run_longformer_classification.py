...
from dataset.notes import notes_train_set
from dataset.papers import papers_train_set, papers_test_set
from dataset.news import news_train_set, news_test_set
from models.longformer_papers import longformer_finetuned_papers
from models.longformer_news import longformer_finetuned_news
...
def main(args):
    ...
    if not os.path.isfile(aggregate_attn_path):
